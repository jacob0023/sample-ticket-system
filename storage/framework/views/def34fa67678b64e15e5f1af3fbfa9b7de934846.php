    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a href="<?php echo e(route('my.tickets.create')); ?>" class="btn btn-dark btn-sm">Create a Ticket</a>
                <hr>
                <form actoin="">
                ...
                <hr>
                    ...
                    <div class="card-body">
                        ...
                        <?php echo csrf_field(); ?>
                        <a href ='/my/tickets/<?php echo e($ticket->id); ?>' ><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
...
<?php endif; ?><?php /**PATH /home/jacobes/phpfile/ticketing_system/resources/views/dashboard.blade.php ENDPATH**/ ?>